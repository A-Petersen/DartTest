...
if(C.a.u(u-t.d)<0)t.c=t.d
u=C.a.u(t.c+t.d)
r=t.db
if(typeof r!=="number")return r.bV();--r
if(u>r)t.c=r-t.d
if(C.a.u(t.b-t.d)<0)t.b=t.d
u=C.a.u(t.b+t.d)
r=t.cy
if(typeof r!=="number")return r.bV();--r
if(u>r)t.b=r-t.d
u=C.f.w("#",J.de(s.ch.h(0,t)))
q=document.querySelector(u)
u=window.screen
s=u.availWidth
u=u.availHeight
...
u.setProperty(s,o,"")
u=q.style
o="rotate("+H.b(C.a.aa(t.b*2+t.c,360))+"deg)"
